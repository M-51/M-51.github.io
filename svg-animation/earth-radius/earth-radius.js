const earthRadius = new SVGAnimationPlayer({
...
group.setAttributeNS(null, 'fill', '#f66');
document.getElementById('earth-group').appendChild(group);
    ...
    animation: {
        d: {
            ...
            value: (t) => {
                ...
                distanceText.innerHTML = `${Math.round(800 + (t * 7840))} km`;
